...
public class Pwd_Change1 extends Activity implements OnClickListener{
	...
	public void onClick(View V) {
		...
		if(a == 0)
        {
	    Intent i=new Intent(Pwd_Change1.this,Pwd_Change2.class);
     	startActivity(i);
     	finish();
        }
		break;
	...
	public Integer pwd_validate(List<PwdDetails> PD)
	{
	    ...
	    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {   
	        	Intent i1=new Intent(Pwd_Change1.this,Pwd_Change1.class);
	         	startActivity(i1);
	         	finish();	
	        }
	     })
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if(keyCode == KeyEvent.KEYCODE_BACK){
			Intent i3=new Intent(Pwd_Change1.this,Passwordmain_Navdrawer.class);
			startActivity(i3);
			finish(); 
		}
